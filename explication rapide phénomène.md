Un poisson ressemble souvent au profil NACA (aile d’avion) qui est la forme la plus adaptée au déplacement dans un fluide (forme qui a le coefficient de traînée le plus faible (Cx(NACA)≈0.04).
